...
import CategoryInterface from '../category/CategoryInteface'
import DisplayAllFormat from '../category/DisplayAllFormat'
...
export default function Dashboard(props) {
  ...
  const [showComponent, setComponent] = React.useState(<CategoryInterface/>);
 ...
 const CheckSession=async()=>{
  ...
  useEffect(function(){
   //console.log('Hello',props.history.location.admin.adminname)
